        ...
        <div className="w-full max-w-4xl mx-auto h-full bg-white rounded-lg shadow-2xl overflow-hidden flex flex-col border border-slate-300">
            ...
            <div className="bg-slate-100 border-b border-slate-300 p-3 pr-2 flex items-center gap-2 shrink-0">
                ...
                {onHelpClick && (
                    <button
                        onClick={onHelpClick}
                        className="w-7 h-7 min-w-[1.75rem] bg-slate-200 hover:bg-slate-300 text-slate-700 rounded flex items-center justify-center font-bold text-sm transition-colors shrink-0"
                        aria-label="Help"
                        title="Help"
                    >
                        ?
